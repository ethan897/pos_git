...
public class Mo_BluetoothService {  
    ...
    private void addBondDevicesToListView() {  
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this.context, data,  
                R.layout.mo_bonddevice_item, from, to);  
        // 把适配器装载到listView中  
                ...
                .setOnItemClickListener(new OnItemClickListener() {  
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1,  
                        ...
                        intent.setClassName(context,  
                                "com.apicloud.moduleprint.PrintDataActivity");   
    ...
    private void addUnbondDevicesToListView() {  
        ...
        int[] to = { R.id.device_name };  
        SimpleAdapter simpleAdapter = new SimpleAdapter(this.context, data,  
                R.layout.mo_unbonddevice_item, from, to);  
    ...
    public Mo_BluetoothService(Context context, ListView unbondDevicesListView,  
